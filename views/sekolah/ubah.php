            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?= form_open_multipart('administrator/sekolah/aksi_ubah') ?>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class=" text-center ">
                                            ...
                                            <span class=""><img class="rounded-circle border border-secondary" id="output" width="200px" height="200px" src="<?= base_url('assets/images/upload_logo_sekolah/') . $row->foto ?>" /></span>
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nama_sekolah" value="<?= $row->nama_sekolah ?>" autocomplete="off">
                                            </div>
                                            <div class="mb-3">
                                                <label>Kelas</label>
                                                <input type="text" data-role="tagsinput" name="kelas" class="form-input" placeholder="Masukkan Nama Kelas" value="<?= $row->kelas ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
